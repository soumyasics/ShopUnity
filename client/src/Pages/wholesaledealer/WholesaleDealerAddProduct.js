...
function WholesaleDealerAddProduct() {
  const [productimage, setProfileImage] = useState(null);
  ...
  const handleSubmit = (event) => {
    ...
    if (formIsValid) {
      ...
      axiosInstance
        .post("/add_product_bywholesale", formData)
        .then((res) => {
          ...
          <div>
            ...
            <div className="shopowner-additem-box">
              ...
              <div className="row container mt-3 ms-5">
                <div className="col">
                  <div>
                    <label className="shopowner-additem-label">
                      Select Category
                    </label>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="shopowner-additem-labelbox mt-2">
                      ...
                      />
                      {errors.expirydate && (
                        <span className="text-danger">{errors.expirydate}</span>
                      )}
                    </div>
                  </div>
                  <div className="mt-3">
                ...
                <div className="col ms-5 me-5">
                    ...
                    <div className="shopowner-additem-labelbox mt-2">
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="mt-3 me-3">
                          <button
                            onClick={decrement}
                            className="shopowner-additem-quantitybtn"
                          >
                            -
                          </button>
                          <button
                            onClick={increment}
                            className="shopowner-additem-quantitybtn1 ms-3"
                          >
                            +
                          </button>
                        </div>
                  ...
                  <div className="text-center mt-4">
                    <button
                      ...
                      className="shopowner-additem-submit"
                    >
                      Submit
                    </button>
                  </div>
