            ...
            <div className="delivery-agent-box">
              ...
              <form onSubmit={handleSubmit}>
                <div className="row">
                  ...
                  <div className="col-8">
                <div>
                    <label className="delivery-agent-login-email mt-3 ">Email</label><br></br>
                    <input 
                ...
                <div>
                  <label className="delivery-agent-login-email mt-3 ">Password</label><br></br>
                  <input 
                    className="form-control delivery-agent-login-textbox mt-2 " 
                    type="Password"
                ...
                <div className="mt-2 delivery-agent-login-forgetpswdlink">
                 <Link  to="" className="delivery-agent-login-forgetpswd">Forgot Password?</Link>
                </div>
                <div>
                  <button type="submit" className="delivery-agent-login-btn mt-4">Login</button>
                </div>
